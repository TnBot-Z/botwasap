...
const instagram = 'https://instagram.com/_mr.bots_'; 
const whatsapp = 'wa.me/6289661976243'; 
const kapanbotaktif = 'Jam 08.00 pagi - 09.00 malam'; 
...
axios.get('https://api.quran.sutanlab.id/surah/'+nmr+"/"+ayat').then((res) => {
    const sr = /{(.*?)}/gi;
